...
function painmed_enqueue_assets() {
	// Google Fonts (V2 редизайн): Manrope (sans) + Inter (text) + JetBrains Mono (mono) + Source Serif 4 (serif italic)
	wp_enqueue_style(
		'painmed-google-fonts',
		'https://fonts.googleapis.com/css2?family=Manrope:wght@400;500;600;700&family=Inter:wght@400;500;600&family=JetBrains+Mono:wght@400;500&family=Source+Serif+4:ital,wght@0,400;0,500;1,400&display=swap',
		array(),
...
function painmed_fallback_menu() {
	...
	echo '<li><a href="/meropriyatiya/">Программы</a></li>';
	echo '<li><a href="/online/">Эфиры</a></li>';
	echo '<li><a href="/arhiv/">Архив</a></li>';
	echo '<li><a href="/ai-consultant/">ИИ-Консультант</a></li>';
	echo '<li><a href="/about/">О проекте</a></li>';
	echo '</ul>';
}
